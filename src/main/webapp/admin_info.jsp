...
<head>
    ...
    <title>管理员信息</title>
    <style>
        .admin_info_style .admin_modify_style{float: none;margin: auto;border-right: none;
            border:1px solid #dddddd;}
        .type_title{width: 100%;height:40px;line-height: 40px;background: #F8F8F8;text-align: center;font-size: 17px;}
        .admin_info_style .Button_operation button{float: none;margin-bottom: 10px;}
        .btn{margin-right: auto;}
        /*.btn-success{margin:10px auto;}*/
        #Personal{height: auto !important;}
        .admin_info_style .Button_operation .btn-success{margin: auto;}
        #Personal{margin-top: 140px !important;}
        .btn-warning{margin-left: 8%;}
    </style>
</head>
<body>
<div class="clearfix">
