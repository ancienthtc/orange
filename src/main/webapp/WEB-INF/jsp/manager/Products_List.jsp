        ...
        $.post(url,info,
            function(result){
                ...
                for(var i=0;i<result.dataList.length;i++)
                {
                    ...
                    tbody.append("<td width='250px'>"+result.dataList[i].name+"</td>");
                    tbody.append("<td width='100px'>"+result.dataList[i].nameJ+"</td>");
                    tbody.append("<td width='100px'>"+result.dataList[i].level+"</td>");
                    tbody.append("<td width='100px'>"+result.dataList[i].priority+"</td>");
                    tbody.append("<td width='180px'>"+result.dataList[i].fname+"</td>");
                    var a="<td>";
                    a+="<a href=\"picture-add.html\" class=\"btn btn-xs btn-info\"><i class=\"icon-edit bigger-120\"></i></a>"
                    a+="<a title=\"删除\" href=\"javascript:;\" onclick=\"member_del(this,'1')\" class=\"btn btn-xs btn-warning\"><i class=\"icon-trash  bigger-120\"></i></a></td>";
