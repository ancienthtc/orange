                        ...
                        <div class="side_list">
                            ...
                            <div class="widget-body">
                                <ul class="b_P_Sort_list">
                                    ...
                                    <li><i class="fa fa-sticky-note pink "></i> <a href="#" id="send2">待发货(${OrderStatus.o2})</a></li>
        ...
        $.post(url,info,
            function(result){
                ...
                for(var i=0;i<result.dataList.length;i++)
                {
                    ...
                    tbody2.append("<td class='td-status'><span class='label label-success radius'>待发货</span></td>");//变

                    a+="<td oid='"+result.dataList[i].sequence+"'>";
                    a+="<a title='发货' class='btn btn-xs btn-success send'><i class='fa fa-cubes bigger-120'></i></a>";
                    a+="<a title='订单详细' href='<%=basePath%>order/toOrderDetail/"+result.dataList[i].sequence+"'" +
                        " class='btn btn-xs btn-info order_detailed'><i class='fa fa-list bigger-120'></i></a>";
                    a+="<a title='删除' href='javascript:;' class='btn btn-xs btn-warning'><i class='fa fa-trash bigger-120'></i></a>";
                    a+="</td>";
