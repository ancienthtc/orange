                            ...
                            <fieldset>
                                <ul>
                                    <li class="frame_style form_error">
                                        ...
                                        <input name="用户名" type="text" id="username"/><i>用户名</i></li>
                                    <li class="frame_style form_error">
...
<script>
    $('#login_btn').on('click', function () {
        ...
        if (num > 0) {
            ...
            var json={ "admin":username , "password":password }
            //var json={ "nickname":1 , "password":2 }
            $.ajax({
                type : 'POST',
                ...
                success : function(data) {
                    ...
                    else if(data=="true")
                    {
                        ...
                        location.href = "<%=basePath%>login/ToAdminIndex" ;
                        layer.close(index);
                    }
                },
                error : function(data) {
