        ...
        <form action="" method="post" class="form form-horizontal" id="form-article-add">
            ...
            <div class="clearfix cl">
                ...
                <div class="formControls col-2 tupian-img" >
                    <img src="<%=basePath%>image/goods/${goods.pic1}" alt="图片">
                </div>
                    </div>
                <div class="fc">
                    <div class="tupian">
                    ...
                    <div class="formControls col-2 tupian-img" >
                        <img src="<%=basePath%>image/goods/${goods.pic2}" alt="图片">
                    </div>
                </div>
                <div class="fc">
                    <div class="tupian">
                    ...
                    <div class="formControls col-2 tupian-img">
                        <img src="<%=basePath%>image/goods/${goods.pic3}" alt="图片">
                    </div>
                </div>
            </div>
            <div class="clearfix cl ">
                    ...
                    <ul class="clearfix">
                        <c:forEach var="item" items="${pictures}">
                            <li class="genduotupin">
                                <img src="<%=basePath%>image/show/${item.filename}" alt="">
                            </li>
                        </c:forEach>
