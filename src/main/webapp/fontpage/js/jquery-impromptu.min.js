...
(function($) {
    ...
    $.prompt = function(message, options) {
        ...
        msgbox += '<div class="'+ opts.prefix +' '+ opts.classes.prompt +'"><div class="'+ opts.prefix +'container">';
        ...
        if(opts.isButtonHide)
        {
            $('.'+ opts.prefix +'buttons button').hide();
        }
        //Events
    ...
    $.prompt.goToState = function(state, callback) {
        ...
        if(!promptstatechanginge.isDefaultPrevented() && $state.length > 0){
            ...
            if(stateobj.isButtonHide)
            {
                $('.jqibuttons').hide();
                $('.jqimessage').css("text-align","center");
                $('.jqimessage').css("padding","10px 0");
            }
